          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <Button className="w-full">Explorar Profesionales</Button>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Programa y gestiona tus citas</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Sigue tu evolución personal</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-2 mb-4">
                  <p className="text-sm">
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Tipo:</span> Cliente
                  </p>
                </div>
                <Button variant="outline" className="w-full">
                  Ver Progreso
              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  <div className="flex flex-col items-center text-center p-4">
                    ...
                    <p className="text-sm text-gray-500">
                      Explora perfiles y especialidades
                    </p>
                  </div>
                  <div className="flex flex-col items-center text-center p-4">
